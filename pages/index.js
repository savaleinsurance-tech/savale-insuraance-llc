...
export default function Home() {
  ...
  const btn = (bg) => ({ background: bg, color: "#fff", borderRadius: 14, padding: "12px 18px", textDecoration: "none", display: "inline-block", fontWeight: 600 });
    ...
    <main style={wrap}>
      ...
      <section id="nosotros" style={{ background: "#fff" }}>
        <div style={{ ...container, padding: "56px 20px" }}>
          ...
          <p style={{ ...p, maxWidth: 900 }}>
            ...
            comparamos opciones y te proponemos planes a tu medida, sin letra pequeña.
          </p>
        </div>
      </section>
      ...
      <section id="servicios" style={{ background: "#f8fafc" }}>
        <div style={{ ...container, padding: "56px 20px" }}>
          ...
          <div style={{ display: "grid", gap: 16, gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))" }}>
            <div style={card}><h3 style={{ margin: "0 0 6px", color: "#0b3b7e" }}>Auto</h3><p style={p}>Daños, robo y responsabilidad civil. Asistencia 24/7.</p></div>
            <div style={card}><h3 style={{ margin: "0 0 6px", color: "#0b3b7e" }}>Hogar</h3><p style={p}>Vivienda y pertenencias protegidas contra imprevistos.</p></div>
            <div style={card}><h3 style={{ margin: "0 0 6px", color: "#0b3b7e" }}>Vida</h3><p style={p}>Respaldo económico a tus seres queridos.</p></div>
            <div style={card}><h3 style={{ margin: "0 0 6px", color: "#0b3b7e" }}>Salud</h3><p style={p}>Consultas, urgencias y bienestar preventivo.</p></div>
            <div style={card}><h3 style={{ margin: "0 0 6px", color: "#0b3b7e" }}>Empresarial</h3><p style={p}>Activos, RC y soluciones para PYMES.</p></div>
          </div>
          <div style={{ marginTop: 18 }}><a href="#contacto" style={btn("#0ea5e9")}>Quiero una propuesta</a></div>
        </div>
      </section>
      ...
      <section id="beneficios" style={{ background: "#fff" }}>
        <div style={{ ...container, padding: "56px 20px" }}>
          ...
          <div style={{ display: "grid", gap: 16, gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))" }}>
            <div style={card}><strong>Asesoría honesta</strong><p style={{ ...p, marginTop: 6 }}>Elegís con confianza, sin letra pequeña.</p></div>
            <div style={card}><strong>Planes a medida</strong><p style={{ ...p, marginTop: 6 }}>Ajustamos coberturas y deducibles a tu presupuesto.</p></div>
            <div style={card}><strong>Acompañamiento real</strong><p style={{ ...p, marginTop: 6 }}>Estamos contigo antes, durante y después.</p></div>
          </div>
        </div>
      </section>
      ...
      <section id="testimonios" style={{ background: "#f8fafc" }}>
        <div style={{ ...container, padding: "56px 20px" }}>
          ...
          <div style={{ display: "grid", gap: 16, gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))" }}>
            <div style={card}><p style={{ ...p, fontStyle: "italic" }}>“Me explicaron todo y bajé el costo del auto sin perder coberturas.”</p><div style={{ marginTop: 8, fontWeight: 600 }}>Carolina M.</div></div>
            <div style={card}><p style={{ ...p, fontStyle: "italic" }}>“En un incidente en casa me guiaron para usar la póliza sin estrés.”</p><div style={{ marginTop: 8, fontWeight: 600 }}>Luis A.</div></div>
            <div style={card}><p style={{ ...p, fontStyle: "italic" }}>“Para mi empresa, paquete completo con RC y salud. Recomendados.”</p><div style={{ marginTop: 8, fontWeight: 600 }}>Andrea R.</div></div>
          </div>
        </div>
      </section>
      ...
      <section id="faq" style={{ background: "#fff" }}>
        <div style={{ ...container, padding: "56px 20px" }}>
          ...
          <div style={{ display: "grid", gap: 12 }}>
            <div style={card}><strong>¿Trabajan con varias aseguradoras?</strong><p style={{ ...p, marginTop: 6 }}>Sí, comparamos para la mejor relación cobertura–precio.</p></div>
            <div style={card}><strong>¿Cuánto tarda una cotización?</strong><p style={{ ...p, marginTop: 6 }}>Normalmente 24–48 horas hábiles según la póliza.</p></div>
            <div style={card}><strong>¿Pueden asesorarme por WhatsApp?</strong><p style={{ ...p, marginTop: 6 }}>Claro, avanzamos paso a paso cuando te quede mejor.</p></div>
          </div>
        </div>
      </section>
      ...
      <section id="contacto" style={{ background: "#0b3b7e", color: "#fff" }}>
        <div style={{ ...container, padding: "56px 20px" }}>
          ...
          <p style={{ fontSize: 17, opacity: 0.95, margin: "0 0 16px" }}>Cuéntanos qué necesitas y te preparamos una propuesta.</p>
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            <a href={whatsapp} target="_blank" rel="noreferrer" style={btn("#22c55e")}>WhatsApp</a>
            <a href={email} style={btn("#f97316")}>Email</a>
